function [olasynth,olawin] = sm_ola(time_frame,framelen,hop,nsample,center_frame,nframe,winflag,cfwflag)
...
%   CFW = sm_cfw(M,CFWFLAG). Type help cfw for further details.
%
...
synthesis_window = sm_mkcolawin(framelen,winflag);
...
for cf = center_frame'
    ...
    % Frame number
    iframe = sm_s2f(cf,cfw(framelen,cfwflag),hop);
