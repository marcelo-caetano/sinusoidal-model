function [sinusoidal,partials,amplitudes,frequencies] = sinusoidal_resynthesis(amp,freq,phase,delta,hopsize,winlen,sr,duration,wintype,center,cframe,synthflag,maxnpeak,dblevel)
