function [amplitude,frequency,phase,duration,dc,cframe] = sinusoidal_analysis(insig,freqs,nfft,hopsize,winlen,wintype,center,normflag,zphflag,magflag,maxnpeak)
