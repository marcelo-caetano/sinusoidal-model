function [fft_frame,nsample,dc,center_frame,nframe] = stft(wav,framelen,hop,nfft,winflag,cfwflag,normflag,zphflag)
%STFT Short-Time Fourier Transform.
%   [ST,NSAMPLE,DC,CFR,NFRAME] = STFT(S,M,H,NFFT,WINFLAG,CFWFLAG) returns the
...
%
%   [ST,...] = STFT(S,M,H,NFFT,WINFLAG,CFWFLAG,NORMFLAG) returns ST
...
%
%   [ST,...] = STFT(S,M,H,NFFT,WINFLAG,CFWFLAG,NORMFLAG,ZPHFLAG) returns ST
...
% Make time frames
[time_frame,nsample,dc,center_frame,nframe] = sof(wav,framelen,hop,winflag,cfwflag,normflag);
