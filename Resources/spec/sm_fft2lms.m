function log_mag_spec = sm_fft2lms(fft_frame,lmsflag,nfft,nrgflag,nanflag)
...
if isempty(nfft)
    ...
    mag_spec = sm_fft2mag(fft_frame);
    
    % Log magnitude spectrum
    log_mag_spec = sm_lin2log(mag_spec,lmsflag,nanflag);
    
else
    
    % Positive magnitude spectrum
    mag_spec = sm_fft2pms(fft_frame,nfft,nrgflag);
