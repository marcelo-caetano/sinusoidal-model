...
%   (dBpower) with NFREQ rows and NFRAME columns, where NFREQ = nyq(NFFT)
...
[fig,figaxes,specgram,nrglbl,timelbl,freqlbl,titlelbl] = plotpeakgram(plotdata.specpeak,plotdata.time,plotdata.frequency);
