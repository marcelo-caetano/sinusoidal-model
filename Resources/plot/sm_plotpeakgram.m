function [fig,figaxes,specgram,nrglbl,timelbl,freqlbl,titlelbl] = sm_plotpeakgram(specpeak,time,frequency)
%PLOTPEAKGRAM Plot peakgram.
%   [FIG,FIGAXES,SPECGRAM,AMPLBL,TIMELBL,FREQLBL,TTL] = PLOTPEAKGRAM(P,T,F)
%
%   Input arguments:
%
...
%
%   See also PLOTSPECTROGRAM, PLOTSPECTROPEAKGRAM, PLOTPARTTRACK
