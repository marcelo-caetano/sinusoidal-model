function fig = sm_mkfigpeakgram(plotdata,axeslim,axeslbl,figlayout)
...
%   (dBpower) with NFREQ rows and NFRAME columns, where NFREQ = sm_nyq(NFFT)
...
[fig,figaxes,specgram,nrglbl,timelbl,freqlbl,titlelbl] = sm_plotpeakgram(plotdata.specpeak,plotdata.time,plotdata.frequency);
