function [fig,figaxes,wavform,timelbl,amplbl,titlelbl] = sm_plotwav(timesample,wav)
%PLOTWAV Plot partial tracks.
%   [FIG,FIGAXES,SPECGRAM,AMPLBL,TIMELBL,AMPLBL,TTL] = PLOTWAV(T,S)
%
%   Input arguments:
%
%   T sample time vector (s)
%   S waveform (Normalized)
%
%   Output arguments:
%
...
%   AMPLBL handle to the text object used as frequency label
