function [fft_frame,nsample,dc,cframe] = sm_stft(wav,framelen,hop,nfft,winflag,cfwflag,normflag,zphflag)
...
% Make time frames
[time_frame,nsample,dc,cframe] = sm_sof(wav,framelen,hop,winflag,cfwflag,normflag);

% zero pad
if nfft > framelen
    
    zpad_frame = sm_flexpad(time_frame,nfft);
...
if zphflag
    ...
    zph_frame = sm_lp2zp(zpad_frame,framelen);
