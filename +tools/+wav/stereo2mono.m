...
%   M = tools.wav.stereo2mono(S) downmixes stereo audio in S into mono audio in M.
%
...
%   tools.wav.stereo2mono returns an error whenever N>2.
%
%   See also tools.wav.downmix, audioread
