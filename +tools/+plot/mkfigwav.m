...
%
%   PLOTDATA.WAV NSAMPLE x NWAV matrix containing the NWAV waveforms
...
% Plot first waveform
[fig,figaxes,wavform,timelbl,amplbl,titlelbl] = tools.plot.plotwav(plotdata.time,plotdata.wav(:,1));
