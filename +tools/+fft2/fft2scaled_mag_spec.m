function scaled_magspec = fft2scaled_mag_spec(fft_frame,nfft,pow,logflag,paramestflag,posfreqflag,nrgflag,nanflag)
...
%
%   SMAGSPEC = FFT2SCALED_MAG_SPEC(FFTFR,NFFT,POW,LOGFLAG,PARAMESTFLAG,
%   POSFREQFLAG) uses the logical flag POSFREQFLAG to specify the frequency
%   range of SMAGSPEC. POSFREQFLAG = FALSE is the default to output the
%   full frequency range of the log magnitude spectrum. POSFREQFLAG = TRUE
...
%
%   SMAGSPEC = FFT2SCALED_MAG_SPEC(FFTFR,NFFT,POW,LOGFLAG,PARAMESTFLAG,
%   POSFREQFLAG,NRGFLAG) uses the logical flag NRGFLAG to control the
...
%
%   SMAGSPEC = FFT2SCALED_MAG_SPEC(FFTFR,NFFT,POW,LOGFLAG,PARAMESTFLAG,
%   POSFREQFLAG,NRGFLAG,NANFLAG) uses the logical flag NANFLAG to handle
...
switch lower(paramestflag)
    ...
    case {'nne','lin'}
        ...
        scaled_magspec = tools.fft2.fft2lin_mag_spec(fft_frame,nfft,posfreqflag,nrgflag);
        
    case 'log'
        
        scaled_magspec = tools.fft2.fft2log_mag_spec(fft_frame,nfft,logflag,posfreqflag,nrgflag,nanflag);
        
    case 'pow'
        
        scaled_magspec = tools.fft2.fft2pow_mag_spec(fft_frame,nfft,pow,posfreqflag,nrgflag,nanflag);
