...
%FFT2POS_MAG_SPEC From FFT to positive magnitude spectrum.
...
%   of the FFT.
%
%   PMS = FFT2POS_MAG_SPEC(FFT,NFFT,NRGFLAG) uses the
...
%   previous syntaxes.
%
%   See also FFT2MAG_SPEC, FFT2PHASE_SPEC,
...
posmagspec = tools.spec.full_spec2pos_spec(magspec,nfft,nrgflag);
