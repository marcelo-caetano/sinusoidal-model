function [new_amp_curr,new_amp_next,new_freq_curr,new_freq_next,new_phase_curr] = ...
    peak_matching_withoutphase(amp_curr,amp_next,freq_curr,freq_next,phase_curr,delta)
