function [sinusoidal,partial,amplitude,frequency,phase] = sm_sinusoidal_resynthesis(amp,freq,ph,framelen,hop,fs,nsample,center_frame,...
...
if isempty(ptrackflag)
    ...
    % Partial tracking
    [amp,freq,ph,npartial] = sm_partial_tracking(amp,freq,ph,delta,hop,fs,nframe,ptrackflag);
