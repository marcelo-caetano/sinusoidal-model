function [amplitude,frequency,phase_argument,synthwin] = sm_stationary_synthesis(amp,freq,ph,framelen,fs,cframe,winflag)
...
synthwin = sm_mkcolawin(framelen,winflag);
