function [sinusoidal,partial,amplitude,frequency,phase] = sm_sinusoidal_resynthesis_PRFI(amp,freq,framelen,hop,fs,nsample,center_frame,...
...
[sinusoidal(range_row),partial(range_row,range_col)] = sm_PRFI_resynthesis(amplitude(range_row,range_col),phase(range_row,range_col));
