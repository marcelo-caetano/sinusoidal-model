function [amp,freq,ph,npart] = sm_partial_tracking(amplitude,frequency,phase,delta,hop,fs,nframe,trackflag)
...
switch lower(trackflag)
    ...
    case 'p2p'
        ...
        [amp,freq,ph,npart] = sm_peak2peak(amplitude,frequency,phase,delta,hop,fs,nframe);
